...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  dtcid =  loginPerson.getApploginId();
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(result != null) {
            ...
            if(result.getContents() == null) {
                //iptal
                Toast.makeText(MainActivity.this,"Qr Kod okuma başarısız !",Toast.LENGTH_LONG).show();
    ...
    private class ConnectService extends AsyncTask<Void,Void,Void>{
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            if(valid){
                ...
                intent.putExtra("dtc", textView_tc.getText());
                intent.putExtra("ApploginKisi", loginPerson.getApploginId());
                startActivity(intent);
